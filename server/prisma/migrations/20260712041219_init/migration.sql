...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('ASSET_ASSIGNED', 'MAINTENANCE_UPDATE', 'BOOKING_UPDATE', 'BOOKING_REMINDER', 'TRANSFER_UPDATE', 'OVERDUE_RETURN', 'AUDIT_DISCREPANCY', 'SYSTEM');
...
-- AddForeignKey
ALTER TABLE "Allocation" ADD CONSTRAINT "Allocation_allocatedToId_fkey" FOREIGN KEY ("allocatedToId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
